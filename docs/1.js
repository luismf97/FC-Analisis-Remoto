...
*/
(function(a){"object"===typeof module&&module.exports?(a["default"]=a,module.exports=a): true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! highcharts */ "./node_modules/highcharts/highcharts.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(m){a(m);a.Highcharts=m;return a}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)):undefined})(function(a){function m(a,l,J,x){a.hasOwnProperty(l)||(a[l]=x.apply(null,J),"function"===typeof CustomEvent&&window.dispatchEvent(new CustomEvent("HighchartsModuleLoaded",{detail:{path:l,module:a[l]}})))}a=a?a._modules:{};m(a,
...
/***/ "./src/app/Consulta/bpms/bpms.component.css":
/*!**************************************************!*\
  !*** ./src/app/Consulta/bpms/bpms.component.css ***!
  \**************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL0NvbnN1bHRhL2JwbXMvYnBtcy5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/Consulta/bpms/bpms.component.html":
/*!***************************************************!*\
  !*** ./src/app/Consulta/bpms/bpms.component.html ***!
  \***************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"container\" style=\"margin-top: 10px;\">\n  <div class=\"row\"> \n    <div class=\"col\">\n      <h5>Seguimientos de Temperatura guardados en Base de datos</h5>\n      <table class=\"table\">\n        <thead>\n          <tr>\n            <th scope=\"col\">Id</th>\n            <th scope=\"col\">Medico</th>\n            <th scope=\"col\">Paciente</th>\n            <th scope=\"col\">Fecha</th>\n            <th scope=\"col\">Descargar</th>\n            <th scope=\"col\">Borrar</th>\n          </tr>\n        </thead>\n        <tbody>\n          <tr *ngFor=\"let registro of registros\">\n            <th scope=\"row\">{{registro.Id}}</th>\n            <th scope=\"row\">{{registro.Name}}</th>\n            <th scope=\"row\">{{registro.Nombre}}</th>\n            <th scope=\"row\">{{registro.FechaRegistro | date:'dd/MM/yyyy':'GMT'}}</th>\n            <th scope=\"row\"><button type=\"button\" class=\"btn btn-success\" (click)=\"download(registro.Datos)\">Descargar</button></th>\n            <th scope=\"row\"><button type=\"button\" class=\"btn btn-danger\" (click)=\"borrar(registro.Id)\">Borrar</button></th>\n          </tr>\n        </tbody>\n      </table>\n    </div>\n  </div>"

/***/ }),

/***/ "./src/app/Consulta/bpms/bpms.component.ts":
/*!*************************************************!*\
  !*** ./src/app/Consulta/bpms/bpms.component.ts ***!
  \*************************************************/
/*! exports provided: BpmsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BpmsComponent", function() { return BpmsComponent; });
...
var BpmsComponent = /** @class */ (function () {
    function BpmsComponent(http) {
        this.http = http;
        this.baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].baseUrl;
        this.dataSocket = [];
        this.mockHeaders = "Value";
        this.fileTitle = 'export-result';
    }
    BpmsComponent.prototype.ngOnInit = function () {
        this.getRegistros();
    };
    BpmsComponent.prototype.getRegistros = function () {
        var _this = this;
        this.http.get(this.baseUrl + 'registrosOtros')
            .subscribe(function (data) {
            _this.registros = data.rows;
        });
    };
    BpmsComponent.prototype.borrarRegistro = function (id) {
        var _this = this;
        this.http.post(this.baseUrl + 'borrarRegistroOtros', { id: id }).subscribe(function (data) {
            if (data.ok == true) {
                _this.registros = [];
                _this.getRegistros();
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire('Borrado', 'El registro ha sido borrado', 'success');
            }
            else {
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire('Oops...', 'Algo salio mal', 'error');
            }
        }, function (err) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire('Oops...', 'Algo salio mal', 'error');
        });
    };
    BpmsComponent.prototype.convertToCSV = function (objArray) {
    ...
    BpmsComponent.prototype.borrar = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
            ...
            if (result.value) {
                _this.borrarRegistro(id);
                // For more information about handling dismissals please visit
                // https://sweetalert2.github.io/#handling-dismissals
            }
            else if (result.dismiss === sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.DismissReason.cancel) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire('Cancelado', 'El registro no se borro', 'error');
            }
        });
    };
    BpmsComponent.prototype.formatToCsvData = function (datos) {
        var jsonObject = datos;
        this.jsonData = jsonObject;
        var csv = this.convertToCSV(jsonObject);
        this.mockCsvData = csv;
    };
    BpmsComponent.prototype.download = function (datos) {
        this.formatToCsvData(datos);
        var exportedFilenmae = this.fileTitle + '.csv';
        var blob = new Blob([this.mockCsvData], { type: 'text/csv;charset=utf-8;' });
    ...
    BpmsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-bpms',
            template: __webpack_require__(/*! ./bpms.component.html */ "./src/app/Consulta/bpms/bpms.component.html"),
            styles: [__webpack_require__(/*! ./bpms.component.css */ "./src/app/Consulta/bpms/bpms.component.css")]
        }),
...
/***/ "./src/app/Consulta/ecgs/ecgs.component.css":
/*!**************************************************!*\
  !*** ./src/app/Consulta/ecgs/ecgs.component.css ***!
  \**************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL0NvbnN1bHRhL2VjZ3MvZWNncy5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/Consulta/ecgs/ecgs.component.html":
/*!***************************************************!*\
  !*** ./src/app/Consulta/ecgs/ecgs.component.html ***!
  \***************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"container\" style=\"margin-top: 10px;\">\n  <div class=\"row\"> \n    <div class=\"col\">\n      <h5>Electrocardiogramas guardados en Base de datos</h5>\n      <table class=\"table\">\n        <thead>\n          <tr>\n            <th scope=\"col\">Id</th>\n            <th scope=\"col\">Fecha</th>\n            <th scope=\"col\">Medico</th>\n            <th scope=\"col\">Paciente</th>\n            <th scope=\"col\">Descargar</th>\n            <th scope=\"col\">Borrar</th>\n          </tr>\n        </thead>\n        <tbody>\n          <tr *ngFor=\"let registro of registros\">\n            <th scope=\"row\">{{registro.Id}}</th>\n            <th scope=\"row\">{{registro.FechaRegistro | date:'dd/MM/yyyy':'GMT'}}</th>\n            <th scope=\"row\">{{registro.Name}}</th>\n            <th scope=\"row\">{{registro.Nombre}}</th>\n            <th scope=\"row\"><button type=\"button\" class=\"btn btn-success\" (click)=\"download(registro.Datos)\">Descargar</button></th>\n            <th scope=\"row\"><button type=\"button\" class=\"btn btn-danger\" (click)=\"borrar(registro.Id)\">Borrar</button></th>\n          </tr>\n        </tbody>\n      </table>\n    </div>\n  </div>"

/***/ }),

/***/ "./src/app/Consulta/ecgs/ecgs.component.ts":
/*!*************************************************!*\
  !*** ./src/app/Consulta/ecgs/ecgs.component.ts ***!
  \*************************************************/
/*! exports provided: EcgsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EcgsComponent", function() { return EcgsComponent; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var EcgsComponent = /** @class */ (function () {
    function EcgsComponent(http, fb) {
        this.http = http;
        this.fb = fb;
    ...
    EcgsComponent.prototype.ngOnInit = function () {
        this.getRegistros();
    };
    EcgsComponent.prototype.getRegistros = function () {
        var _this = this;
    ...
    EcgsComponent.prototype.borrarRegistro = function (id) {
        var _this = this;
        this.http.post(this.baseUrl + 'borrarRegistro', { id: id }).subscribe(function (data) {
            if (data.ok == true) {
                _this.registros = [];
                _this.getRegistros();
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Borrado', 'El registro ha sido borrado', 'success');
            }
            else {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Oops...', 'Algo salio mal', 'error');
            }
        }, function (err) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Oops...', 'Algo salio mal', 'error');
        });
    };
    EcgsComponent.prototype.convertToCSV = function (objArray) {
        var array = typeof objArray != 'object' ? JSON.parse(objArray) : objArray;
        var str = '';
        for (var i = 0; i < array.length; i++) {
            var line = '';
    ...
    EcgsComponent.prototype.borrar = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
            ...
            if (result.value) {
                ...
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Cancelado', 'El registro no se borro', 'error');
            }
        });
    };
    EcgsComponent.prototype.download = function (datos) {
        var arr = datos.split(',').map(function (element) {
            return Number(element);
        });
        arr.pop();
        this.dataSocket = this.dataSocket.concat(arr);
        var itemsFormatted = [];
        itemsFormatted.push({
            value: 'LECTURA'
        });
        this.dataSocket.forEach(function (item) {
            itemsFormatted.push({
                value: item
            });
        });
    ...
    EcgsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-ecgs',
            template: __webpack_require__(/*! ./ecgs.component.html */ "./src/app/Consulta/ecgs/ecgs.component.html"),
            styles: [__webpack_require__(/*! ./ecgs.component.css */ "./src/app/Consulta/ecgs/ecgs.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]])
    ], EcgsComponent);
    return EcgsComponent;
}());
...
/***/ "./src/app/Consulta/temperatura/temperatura.component.css":
/*!****************************************************************!*\
  !*** ./src/app/Consulta/temperatura/temperatura.component.css ***!
  \****************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL0NvbnN1bHRhL3RlbXBlcmF0dXJhL3RlbXBlcmF0dXJhLmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/Consulta/temperatura/temperatura.component.html":
/*!*****************************************************************!*\
  !*** ./src/app/Consulta/temperatura/temperatura.component.html ***!
  \*****************************************************************/
/*! no static exports found */
...
/***/ "./src/app/Consulta/temperatura/temperatura.component.ts":
/*!***************************************************************!*\
  !*** ./src/app/Consulta/temperatura/temperatura.component.ts ***!
  \***************************************************************/
/*! exports provided: TemperaturaComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TemperaturaComponent", function() { return TemperaturaComponent; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/environments/environment */ "./src/environments/environment.ts");
...
var TemperaturaComponent = /** @class */ (function () {
    function TemperaturaComponent(http, fb) {
        this.http = http;
        this.fb = fb;
        this.baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl;
        this.dataSocket = [];
    ...
    TemperaturaComponent.prototype.ngOnInit = function () {
        this.getRegistros();
    };
    TemperaturaComponent.prototype.getRegistros = function () {
        var _this = this;
    ...
    TemperaturaComponent.prototype.borrarRegistro = function (id) {
        var _this = this;
        this.http.post(this.baseUrl + 'borrarRegistroTemp', { id: id }).subscribe(function (data) {
            if (data.ok == true) {
                _this.registros = [];
                _this.getRegistros();
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Borrado', 'El registro ha sido borrado', 'success');
    ...
    TemperaturaComponent.prototype.convertToCSV = function (objArray) {
        var array = typeof objArray != 'object' ? JSON.parse(objArray) : objArray;
        var str = '';
        for (var i = 0; i < array.length; i++) {
            var line = '';
    ...
    TemperaturaComponent.prototype.borrar = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
            title: '¿Estas seguro?',
            text: 'Estas a punto de borrar un registro',
    ...
    TemperaturaComponent.prototype.formatToCsvData = function (datos) {
        var jsonObject = datos;
        this.jsonData = jsonObject;
        var csv = this.convertToCSV(jsonObject);
        this.mockCsvData = csv;
    };
    TemperaturaComponent.prototype.download = function (datos) {
        this.formatToCsvData(datos);
        var exportedFilenmae = this.fileTitle + '.csv';
        var blob = new Blob([this.mockCsvData], { type: 'text/csv;charset=utf-8;' });
        var link = document.createElement('a');
    ...
    TemperaturaComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./temperatura.component.html */ "./src/app/Consulta/temperatura/temperatura.component.html"),
            styles: [__webpack_require__(/*! ./temperatura.component.css */ "./src/app/Consulta/temperatura/temperatura.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]])
...
/***/ "./src/app/components/grafica/grafica.component.css":
/*!**********************************************************!*\
  !*** ./src/app/components/grafica/grafica.component.css ***!
  \**********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvZ3JhZmljYS9ncmFmaWNhLmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/components/grafica/grafica.component.html":
/*!***********************************************************!*\
  !*** ./src/app/components/grafica/grafica.component.html ***!
  \***********************************************************/
/*! no static exports found */
...
/* harmony import */ var src_app_services_validar_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/services/validar.service */ "./src/app/services/validar.service.ts");
...
var GraficaComponent = /** @class */ (function () {
    function GraficaComponent(http, wsService, fb, ValidarService) {
        this.http = http;
        ...
        this.dataSocket = [];
        this.mockHeaders = "Value";
        this.fileTitle = 'registro-ecg';
        this.miFormulario = this.fb.group({
            pacienteId: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_7__["Validators"].required]
        });
        this.lineChartData = [
            { data: [1, 2, 3, 4] }
        ];
        this.lineChartLabels = [1, 2, 3, 4];
    ...
    GraficaComponent.prototype.getConectado = function () {
        var _this = this;
        this.http.get('https://ecg-server.herokuapp.com/usuarios/detalle')
            .subscribe(function (data) {
            if (data.clientes == undefined) {
                _this.conectado = "desconectado";
            }
            else {
                _this.conectado = "conectado";
            }
        });
    };
    GraficaComponent.prototype.getPacientes = function () {
        var _this = this;
        this.http.get(this.baseUrl + 'pacientes')
            .subscribe(function (data) {
            _this.pacientes = data.rows;
        });
    };
    GraficaComponent.prototype.detener = function () {
        this.http.get(this.baseUrl + 'detener')
            .subscribe(function (data) { return console.log("detener"); });
    };
    GraficaComponent.prototype.iniciar = function () {
        this.http.get(this.baseUrl + 'iniciar')
            .subscribe(function (data) { return console.log("iniciar"); });
    };
    GraficaComponent.prototype.escucharSocket = function () {
        var _this = this;
        this.wsService.listen('data').subscribe(function (data) {
            for (var propiedad in data) {
                if (data.hasOwnProperty(propiedad)) {
                    var valor = data[propiedad];
                    var arr = valor.split(',').map(function (element) {
                        return Number(element);
                    });
                    arr.pop();
                    _this.chart.addPoint(arr[arr.length / 2]);
                    _this.dataSocket = _this.dataSocket.concat(arr);
                }
            }
        });
    };
    GraficaComponent.prototype.escucharClientes = function () {
        var _this = this;
        this.wsService.listen('usuarios-activos').subscribe(function (data) {
            if (data.length == 0) {
                _this.conectado = "desconectado";
            }
            else {
    ...
    GraficaComponent.prototype.convertToCSV = function (objArray) {
        var array = typeof objArray != 'object' ? JSON.parse(objArray) : objArray;
        var str = '';
        for (var i = 0; i < array.length; i++) {
            var line = '';
    ...
    GraficaComponent.prototype.formatToCsvData = function () {
        var itemsFormatted = [];
        itemsFormatted.push({
            value: 'LECTURA'
        });
    ...
    GraficaComponent.prototype.download = function () {
    ...
    GraficaComponent.prototype.getTipoRol = function () {
        this.tipoRol = this.ValidarService.tipoRol();
        this.usuario = this.ValidarService.usuarioId();
    };
    GraficaComponent.prototype.guardarData = function () {
        var pacienteId = this.miFormulario.value.pacienteId;
        this.http.post(this.baseUrl + 'guardarEcg', { medico: this.usuario, paciente: pacienteId, datos: this.dataSocket }).subscribe(function (data) {
            if (data.ok == true) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_9___default.a.fire('Guardado', 'El registro ha sido guardado correctamente', 'success');
            }
            else {
                sweetalert2__WEBPACK_IMPORTED_MODULE_9___default.a.fire('Oops...', 'Algo salio mal', 'error');
            }
        }, function (err) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_9___default.a.fire('Oops...', 'Algo salio mal', 'error');
        });
    ...
    GraficaComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./grafica.component.html */ "./src/app/components/grafica/grafica.component.html"),
            styles: [__webpack_require__(/*! ./grafica.component.css */ "./src/app/components/grafica/grafica.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"],
            _services_websocket_service__WEBPACK_IMPORTED_MODULE_2__["WebsocketService"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormBuilder"],
            src_app_services_validar_service__WEBPACK_IMPORTED_MODULE_8__["ValidarService"]])
    ], GraficaComponent);
...
module.exports = "\r\n\t<div class=\"container\" style=\"margin-top: 10px;\">\r\n\r\n        <div class=\"card\">\r\n            <div class=\"card-body\">\r\n              <h5 class=\"card-title\">Bienvenido a análisis remoto</h5>\r\n              <p class=\"card-text\">A continuación te mostramos algunos datos del sistema:</p>\r\n            </div>\r\n          </div>\r\n        \r\n\t\t<div class=\"row\">\r\n\t\t\t<div class=\"col-lg-6 col-md-6 col-sm-12\">\r\n\t\t\t\t<div class=\"card\" style=\"margin: 5px;\">\r\n\t\t\t\t\t<div class=\"card-body\">\r\n\t\t\t\t\t\t<h4 class=\"card-title\">Operadores:</h4>\r\n\t\t\t\t\t\t<p class=\"card-text\">{{operadores}} operadores registrados en el sistema.</p>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t\t<div class=\"col-lg-6 col-md-6 col-sm-12\">\r\n\t\t\t\t<div class=\"card\" style=\"margin: 5px;\">\r\n\t\t\t\t\t<div class=\"card-body\">\r\n\t\t\t\t\t\t<h4 class=\"card-title\">Pacientes</h4>\r\n\t\t\t\t\t\t<p class=\"card-text\">{{pacientes}} pacientes registrados en el sistema.</p>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t\t<div class=\"col-lg-6 col-md-6 col-sm-12\">\r\n\t\t\t\t<div class=\"card\" style=\"margin: 5px;\">\r\n\t\t\t\t\t<div class=\"card-body\">\r\n\t\t\t\t\t\t<h4 class=\"card-title\">Electrocardiogramas</h4>\r\n\t\t\t\t\t\t<p class=\"card-text\">{{electros}} electrocardiogramas realizidaos.</p>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n            <div class=\"col-lg-6 col-md-6 col-sm-12\">\r\n\t\t\t\t<div class=\"card\" style=\"margin: 5px;\">\r\n\t\t\t\t\t<div class=\"card-body\">\r\n\t\t\t\t\t\t<h4 class=\"card-title\">Temperatura</h4>\r\n\t\t\t\t\t\t<p class=\"card-text\">{{temps}} registros de Temperatura.</p>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n            <div class=\"col-lg-6 col-md-6 col-sm-12\">\r\n\t\t\t\t<div class=\"card\" style=\"margin: 5px;\">\r\n\t\t\t\t\t<div class=\"card-body\">\r\n\t\t\t\t\t\t<h4 class=\"card-title\">Otros</h4>\r\n\t\t\t\t\t\t<p class=\"card-text\">{{otros}} registros de otros datos.</p>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t</div>\r\n\r\n\t<div class=\"row container\">\r\n\t\t<div class=\"col-lg-6 col-md-6 col-sm-12\">\r\n\t\t\t<div id=\"pie-chart\"></div>\r\n\t\t</div>\r\n\t\t<div class=\"col-lg-6 col-md-6 col-sm-12\">\r\n\t\t\t<div id=\"pie2-chart\"></div>\r\n\t\t</div>\r\n\t</div>"
...
var InicioComponent = /** @class */ (function () {
    ...
    InicioComponent.prototype.drawChart = function () {
        var chartOptions = {
            chart: {
                type: 'pie',
                renderTo: 'pie-chart'
        ...
        highcharts__WEBPACK_IMPORTED_MODULE_2__["chart"]('pie-chart', chartOptions);
    };
    InicioComponent.prototype.drawChart2 = function () {
        var chartOptions = {
            chart: {
                type: 'pie',
                renderTo: 'pie2-chart'
        ...
        highcharts__WEBPACK_IMPORTED_MODULE_2__["chart"]('pie2-chart', chartOptions);
    };
    InicioComponent.prototype.getDatos = function () {
        var _this = this;
        this.http.get(this.baseUrl + 'dashboard')
            .subscribe(function (data) {
            _this.operadores = parseInt(data.rows[0].TotalUsuarios);
            _this.pacientes = parseInt(data.rows[0].TotalPacientes);
            _this.electros = parseInt(data.rows[0].TotalECG);
            _this.bpms = parseInt(data.rows[0].TotalBPM);
            _this.temps = parseInt(data.rows[0].TotalTemperatura);
            _this.otros = parseInt(data.rows[0].TotalRegistros);
            _this.drawChart();
            _this.drawChart2();
        });
    };
...
/***/ "./src/app/components/otros/otros.component.css":
/*!******************************************************!*\
  !*** ./src/app/components/otros/otros.component.css ***!
  \******************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvb3Ryb3Mvb3Ryb3MuY29tcG9uZW50LmNzcyJ9 */"

/***/ }),

/***/ "./src/app/components/otros/otros.component.html":
/*!*******************************************************!*\
  !*** ./src/app/components/otros/otros.component.html ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/otros/otros.component.ts":
/*!*****************************************************!*\
  !*** ./src/app/components/otros/otros.component.ts ***!
  \*****************************************************/
...
var OtrosComponent = /** @class */ (function () {
    function OtrosComponent(http, wsService, fb, ValidarService) {
        this.http = http;
        this.wsService = wsService;
        this.fb = fb;
        this.ValidarService = ValidarService;
    ...
    OtrosComponent.prototype.getConectado = function () {
        var _this = this;
        this.http.get('https://ecg-server.herokuapp.com/usuarios/detalle')
            .subscribe(function (data) {
            if (data.clientes == undefined) {
    ...
    OtrosComponent.prototype.detener = function () {
        this.http.get(this.baseUrl + 'detener')
            .subscribe(function (data) { return console.log("detener"); });
    };
    OtrosComponent.prototype.iniciar = function () {
        this.http.get(this.baseUrl + 'otros')
            .subscribe(function (data) { return console.log("iniciar"); });
    };
    OtrosComponent.prototype.escucharSocket = function () {
        var _this = this;
        this.wsService.listen('data').subscribe(function (data) {
            console.log(data);
            for (var propiedad in data) {
                if (data.hasOwnProperty(propiedad)) {
                    ...
                    arr.pop();
                    _this.chart.addPoint(arr[0]);
                    _this.dataSocket = _this.dataSocket.concat(arr);
                }
            }
        });
    };
    OtrosComponent.prototype.escucharClientes = function () {
        var _this = this;
        this.wsService.listen('usuarios-activos').subscribe(function (data) {
            if (data.length == 0) {
                _this.conectado = "desconectado";
    ...
    OtrosComponent.prototype.convertToCSV = function (objArray) {
        var array = typeof objArray != 'object' ? JSON.parse(objArray) : objArray;
        var str = '';
        for (var i = 0; i < array.length; i++) {
            var line = '';
    ...
    OtrosComponent.prototype.formatToCsvData = function () {
        var itemsFormatted = [];
        itemsFormatted.push({
            value: 'LECTURA'
        });
    ...
    OtrosComponent.prototype.download = function () {
        this.formatToCsvData();
        var exportedFilenmae = this.fileTitle + '.csv';
        var blob = new Blob([this.mockCsvData], { type: 'text/csv;charset=utf-8;' });
        var link = document.createElement('a');
    ...
    OtrosComponent.prototype.getTipoRol = function () {
        this.tipoRol = this.ValidarService.tipoRol();
        this.usuario = this.ValidarService.usuarioId();
    };
    OtrosComponent.prototype.guardarData = function () {
        var pacienteId = this.miFormulario2.value.pacienteId;
        this.http.post(this.baseUrl + 'guardarRegistro', { medico: this.usuario, paciente: pacienteId, datos: this.dataSocket, tipo: "Otros" }).subscribe(function (data) {
            if (data.ok == true) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_9___default.a.fire('Guardado', 'El registro ha sido guardado correctamente', 'success');
            }
            else {
    ...
    OtrosComponent.prototype.configurar = function () {
        var datosPorPaquete = this.miFormulario.value.datosPorPaquete;
        var numeroPaquetes = this.miFormulario.value.numeroPaquetes;
        var frecuencia = this.miFormulario.value.frecuencia;
        this.http.post(this.baseUrl + 'otroRegistroConf', { datosPorPaquete: datosPorPaquete, numeroPaquetes: numeroPaquetes, frecuencia: frecuencia }).subscribe(function (data) {
            if (data.ok == true) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_9___default.a.fire('Configurado', 'Los parametros fueron configurados', 'success');
            }
            else {
                sweetalert2__WEBPACK_IMPORTED_MODULE_9___default.a.fire('Oops...', 'Algo salio mal', 'error');
            }
    ...
    OtrosComponent.prototype.getPacientes = function () {
        var _this = this;
        this.http.get(this.baseUrl + 'pacientes')
            .subscribe(function (data) {
            _this.pacientes = data.rows;
    ...
    OtrosComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-otros',
            template: __webpack_require__(/*! ./otros.component.html */ "./src/app/components/otros/otros.component.html"),
            styles: [__webpack_require__(/*! ./otros.component.css */ "./src/app/components/otros/otros.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"],
            _services_websocket_service__WEBPACK_IMPORTED_MODULE_2__["WebsocketService"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormBuilder"],
...
module.exports = "<div class=\"container\" style=\"margin-top: 10px;\">\r\n  <div class=\"row\"> \r\n    <div class=\"col\">\r\n      <h5>Pacientes Registrados:</h5>\r\n      <table class=\"table\">\r\n        <thead>\r\n          <tr>\r\n            <th scope=\"col\">Id</th>\r\n            <th scope=\"col\">Nombre</th>\r\n            <th scope=\"col\">Correo</th>\r\n            <th scope=\"col\">Genero</th>\r\n            <th scope=\"col\">Nacimiento</th>\r\n            <th scope=\"col\">Contacto</th>\r\n          </tr>\r\n        </thead>\r\n        <tbody>\r\n          <tr *ngFor=\"let paciente of pacientes\">\r\n            <th>{{paciente.Id}}</th>\r\n            <td>{{paciente.Nombre}}</td>\r\n            <td>{{paciente.Correo}}</td>\r\n            <td>{{paciente.Genero}}</td>\r\n            <td>{{paciente.Nacimiento | date}}</td>\r\n            <td>{{paciente.Telefono}}</td>\r\n          </tr>\r\n        </tbody>\r\n      </table>\r\n    </div>\r\n  </div>\r\n  <div class=\"row\">\r\n    <div class=\"col\" *ngIf=\"tipoRol == 1\">\r\n      <button type=\"button\" class=\"btn btn-success\"   data-bs-toggle=\"modal\" data-bs-target=\"#exampleModal\" style=\"margin-right: 20px;\"> Registrar Paciente </button>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<!-- Modal -->\r\n<div class=\"modal fade\" id=\"exampleModal\" tabindex=\"-1\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\r\n  <div class=\"modal-dialog\">\r\n    <div class=\"modal-content\">\r\n      <div class=\"modal-header\">\r\n        <h1 class=\"modal-title fs-5\" id=\"exampleModalLabel\">Registro de Paciente</h1>\r\n        <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"modal\" aria-label=\"Close\"></button>\r\n      </div>\r\n      <div class=\"modal-body\">\r\n\r\n\r\n        <form [formGroup]=\"miFormulario\" (ngSubmit)=\"registrar()\">\r\n          <div class=\"mb-3\">\r\n            <label class=\"form-label\">Nombre del Paciente</label>\r\n            <input type=\"text\" class=\"form-control\" formControlName=\"nombre\">\r\n          </div>\r\n          <div class=\"mb-3\">\r\n            <label for=\"exampleInputPassword1\" class=\"form-label\">Correo del Paciente</label>\r\n            <input type=\"email\" class=\"form-control\" formControlName=\"correo\">\r\n          </div>\r\n<!--           <div class=\"mb-3\">\r\n            <label class=\"form-label\">Genero</label>\r\n            <input type=\"text\" class=\"form-control\" formControlName=\"genero\">\r\n          </div> -->\r\n          <div class=\"mb-3\">\r\n            <label for=\"exampleInputPassword1\" class=\"form-label\">Genero</label>\r\n            <select class=\"form-select\" aria-label=\"Area\" formControlName=\"genero\">\r\n              <option *ngFor=\"let item of generos\" [ngValue]=\"item.Id\">{{item.Genero}}</option>\r\n            </select>\r\n          </div>\r\n<!--           <div class=\"mb-3\">\r\n            <label class=\"form-label\">Fecha de Nacimiento</label>\r\n            <input type=\"text\" class=\"form-control\" formControlName=\"fecha\">\r\n          </div> -->\r\n          <div class=\"mb-3\">\r\n            <label class=\"form-label\">Fecha:</label>\r\n            <input type=\"text\" class=\"form-control\" id=\"fecha\" name=\"fecha\" formControlName=\"fecha\">\r\n          </div>\r\n          <div class=\"mb-3\">\r\n            <label class=\"form-label\">Telefono</label>\r\n            <input type=\"text\" class=\"form-control\" formControlName=\"telefono\">\r\n          </div>\r\n          <div id=\"emailHelp\" class=\"form-text\">*Recuerda revisar que los datos esten correctos</div>\r\n        </form>\r\n\r\n\r\n      </div>\r\n      <div class=\"modal-footer\">\r\n        <button type=\"button\" class=\"btn btn-secondary\" data-bs-dismiss=\"modal\">Cancelar</button>\r\n        <button type=\"button\" class=\"btn btn-primary\" (click)=\"registrar()\"  [disabled]=\"miFormulario.invalid\">Registrar</button>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n\r\n"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var src_app_services_validar_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/validar.service */ "./src/app/services/validar.service.ts");
...
var PacientesComponent = /** @class */ (function () {
    function PacientesComponent(http, fb, ValidarService) {
        this.http = http;
        this.fb = fb;
        this.ValidarService = ValidarService;
    ...
    PacientesComponent.prototype.ngOnInit = function () {
        ...
        this.getTipoRol();
        this.getPacientes();
        jquery__WEBPACK_IMPORTED_MODULE_6__('#fecha').datepicker({
            format: 'dd/mm/yyyy',
            autoclose: true,
            todayHighlight: true,
            language: 'es'
        }).on('changeDate', function (e) {
            var fechaSeleccionada = e.format('yyyy/mm/dd');
            _this.miFormulario.patchValue({ fecha: fechaSeleccionada });
        });
    };
    ...
    PacientesComponent.prototype.getGeneros = function () {
        var _this = this;
        this.http.get(this.baseUrl + 'getGeneros')
            .subscribe(function (data) {
            _this.generos = data.rows;
        });
    };
    PacientesComponent.prototype.getTipoRol = function () {
        this.tipoRol = this.ValidarService.tipoRol();
        if (this.tipoRol == 1) {
            this.getGeneros();
        }
    };
    PacientesComponent.prototype.registrar = function () {
        var _this = this;
        var _a = this.miFormulario.value, nombre = _a.nombre, correo = _a.correo, genero = _a.genero, fecha = _a.fecha, telefono = _a.telefono;
        this.http.post(this.baseUrl + 'registrarPaciente', { nombre: nombre, correo: correo, genero: genero, fecha: fecha, telefono: telefono }).subscribe(function (data) {
            if (data.ok == true) {
                _this.getPacientes();
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Registrado', data.mensaje, 'success');
            }
            else {
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Oops...', 'Algo salio mal', 'error');
            }
        }, function (err) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Oops...', 'Algo salio mal', 'error');
        });
    ...
    PacientesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./pacientes.component.html */ "./src/app/components/pacientes/pacientes.component.html"),
            styles: [__webpack_require__(/*! ./pacientes.component.css */ "./src/app/components/pacientes/pacientes.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
            src_app_services_validar_service__WEBPACK_IMPORTED_MODULE_3__["ValidarService"]])
    ], PacientesComponent);
...
/***/ "./src/app/components/registros/registros.component.css":
/*!**************************************************************!*\
  !*** ./src/app/components/registros/registros.component.css ***!
  \**************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvcmVnaXN0cm9zL3JlZ2lzdHJvcy5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/components/registros/registros.component.html":
/*!***************************************************************!*\
  !*** ./src/app/components/registros/registros.component.html ***!
  \***************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"container\" style=\"margin-top: 5px;\">\r\n  <button type=\"button\" (click)='verEcgs()' class=\"btn btn-primary\" style=\"margin-right: 5px;\">Electrocardiogramas</button>\r\n  <button type=\"button\" (click)='verTemp()' class=\"btn btn-primary\" style=\"margin-right: 5px;\">Temperatura</button>\r\n  <button type=\"button\" (click)='verOtros()' class=\"btn btn-primary\" style=\"margin-right: 5px;\">Otros Registros</button>\r\n</div>\r\n\r\n<div *ngIf=\"verEcgsFlag\">\r\n  <app-ecgs></app-ecgs>\r\n</div>\r\n\r\n<div *ngIf=\"verBpmsFlag\">\r\n  <app-bpms></app-bpms>\r\n</div>\r\n\r\n<div *ngIf=\"verTempFlag\">\r\n  <app-temperatura></app-temperatura>\r\n</div>\r\n\r\n<div *ngIf=\"verOtrosFlag\">\r\n  <app-bpms></app-bpms>\r\n</div>\r\n\r\n"

/***/ }),

/***/ "./src/app/components/registros/registros.component.ts":
/*!*************************************************************!*\
  !*** ./src/app/components/registros/registros.component.ts ***!
  \*************************************************************/
...
var RegistrosComponent = /** @class */ (function () {
    ...
    RegistrosComponent.prototype.verEcgs = function () {
        this.verEcgsFlag = true;
        this.verBpmsFlag = false;
        this.verTempFlag = false;
        this.verOtrosFlag = false;
    };
    RegistrosComponent.prototype.verBpms = function () {
        this.verEcgsFlag = false;
        this.verBpmsFlag = true;
        this.verTempFlag = false;
        this.verOtrosFlag = false;
    };
    RegistrosComponent.prototype.verTemp = function () {
        this.verEcgsFlag = false;
        this.verBpmsFlag = false;
        this.verTempFlag = true;
        this.verOtrosFlag = false;
    };
    RegistrosComponent.prototype.verOtros = function () {
        this.verEcgsFlag = false;
        this.verBpmsFlag = false;
        this.verTempFlag = false;
        this.verOtrosFlag = true;
    };
    RegistrosComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-registros',
            template: __webpack_require__(/*! ./registros.component.html */ "./src/app/components/registros/registros.component.html"),
            styles: [__webpack_require__(/*! ./registros.component.css */ "./src/app/components/registros/registros.component.css")]
        }),
...
/***/ "./src/app/components/temperatura/temp.component.css":
/*!***********************************************************!*\
  !*** ./src/app/components/temperatura/temp.component.css ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvdGVtcGVyYXR1cmEvdGVtcC5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/components/temperatura/temp.component.html":
/*!************************************************************!*\
  !*** ./src/app/components/temperatura/temp.component.html ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"container\" style=\"margin-top: 10px;\">\n  <div class=\"row\">\n      <div class=\"col-12\">\n          <p *ngIf=\"conectado == 'desconectado'\" style=\"color: red\">NodeMCU esta: {{conectado}} </p>\n          <p *ngIf=\"conectado == 'conectado'\" style=\"color: green\">NodeMCU esta: {{conectado}} </p>\n          <button *ngIf=\"tipoRol == 1\" type=\"button\" class=\"btn btn-primary\" (click)=\"iniciar()\" style=\"margin-right: 10px;\">Iniciar</button>\n          <button *ngIf=\"tipoRol == 1\" type=\"button\" class=\"btn btn-danger\" (click)=\"detener()\">Detener</button>\n          <div [chart]=\"chart\"></div>\n          <button type=\"button\" [disabled]=\"dataSocket.length == 0\" class=\"btn btn-success\" (click)=\"download()\" style=\"margin-right: 20px;\"> Descargar CSV </button>\n          <button type=\"button\" [disabled]=\"dataSocket.length == 0\" class=\"btn btn-primary\"   data-bs-toggle=\"modal\" data-bs-target=\"#exampleModal\" style=\"margin-right: 20px;\">Guardar en Base de Datos </button>\n\n      </div>\n  </div>\n</div>\n\n<!-- Modal -->\n<div class=\"modal fade\" id=\"exampleModal\" tabindex=\"-1\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <h1 class=\"modal-title fs-5\" id=\"exampleModalLabel\">Guardar registro en sistema</h1>\n        <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"modal\" aria-label=\"Close\"></button>\n      </div>\n      <div class=\"modal-body\">\n\n\n        <form [formGroup]=\"miFormulario\" (ngSubmit)=\"guardarData()\">\n          <div class=\"mb-3\">\n            <label class=\"form-label\">Nombre del Paciente</label>\n            <select class=\"form-select\" aria-label=\"Default select example\" formControlName=\"pacienteId\">\n              <option *ngFor=\"let paciente of pacientes\" [value]=\"paciente.Id\" >{{paciente.Nombre}}</option>\n            </select>\n          </div>\n        </form>\n\n\n      </div>\n      <div class=\"modal-footer\">\n        <button type=\"button\" class=\"btn btn-secondary\" data-bs-dismiss=\"modal\">Cancelar</button>\n        <button type=\"button\" class=\"btn btn-primary\"     [disabled]=\"miFormulario.invalid\" (click)=\"guardarData()\">Registrar</button>\n      </div>\n    </div>\n  </div>\n</div>\n\n\n\n\n"

/***/ }),

/***/ "./src/app/components/temperatura/temp.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/components/temperatura/temp.component.ts ***!
  \**********************************************************/
...
/* harmony import */ var src_app_services_validar_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/validar.service */ "./src/app/services/validar.service.ts");
...
var TempComponent = /** @class */ (function () {
    function TempComponent(http, wsService, fb, ValidarService) {
        this.http = http;
        this.wsService = wsService;
        this.fb = fb;
        this.ValidarService = ValidarService;
        ...
        this.dataSocket = [];
        this.mockHeaders = "Value";
        this.fileTitle = 'registro-temp';
        this.hora = [];
        this.miFormulario = this.fb.group({
            pacienteId: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required]
        });
        this.lineChartData = [
            { data: [1, 2, 3, 4] }
        ];
    ...
    TempComponent.prototype.getTipoRol = function () {
        this.tipoRol = this.ValidarService.tipoRol();
        this.usuario = this.ValidarService.usuarioId();
    };
    TempComponent.prototype.getConectado = function () {
        var _this = this;
        this.http.get('https://ecg-server.herokuapp.com/usuarios/detalle')
            .subscribe(function (data) {
            if (data.clientes == undefined) {
    ...
    TempComponent.prototype.getPacientes = function () {
        var _this = this;
        this.http.get(this.baseUrl + 'pacientes')
            .subscribe(function (data) {
            _this.pacientes = data.rows;
    ...
    TempComponent.prototype.detener = function () {
        this.http.get(this.baseUrl + 'detener')
            .subscribe(function (data) { return console.log("detener"); });
    };
    TempComponent.prototype.iniciar = function () {
        this.http.get(this.baseUrl + 'iniciarTemp')
            .subscribe(function (data) { return console.log("iniciar"); });
    };
    TempComponent.prototype.escucharSocket = function () {
        var _this = this;
        this.wsService.listen('data_temp').subscribe(function (data) {
            var datos = data.now;
            if (datos == null) {
                //console.log("DatosNull")
            }
            else {
                _this.chart.addPoint(datos);
                _this.dataSocket = _this.dataSocket.concat(datos);
                var date = new Date();
                _this.hora.push(date);
            }
        });
    };
    TempComponent.prototype.escucharClientes = function () {
        var _this = this;
        this.wsService.listen('usuarios-activos').subscribe(function (data) {
            if (data.length == 0) {
                _this.conectado = "desconectado";
    ...
    TempComponent.prototype.convertToCSV = function (objArray) {
        var array = typeof objArray != 'object' ? JSON.parse(objArray) : objArray;
        var str = '';
        for (var i = 0; i < array.length; i++) {
            var line = '';
    ...
    TempComponent.prototype.formatToCsvData = function () {
        var _this = this;
        var itemsFormatted = [];
        itemsFormatted.push({
            value: 'LECTURA',
        ...
        this.dataSocket.forEach(function (item, index) {
            itemsFormatted.push({
                value: item,
                date: _this.hora[index]
            });
        });
        var jsonObject = JSON.stringify(itemsFormatted);
        this.jsonData = jsonObject;
    ...
    TempComponent.prototype.download = function () {
        this.formatToCsvData();
        var exportedFilenmae = this.fileTitle + '.csv';
        var blob = new Blob([this.mockCsvData], { type: 'text/csv;charset=utf-8;' });
        var link = document.createElement('a');
    ...
    TempComponent.prototype.guardarData = function () {
        var pacienteId = this.miFormulario.value.pacienteId;
        this.formatToCsvData();
        this.http.post(this.baseUrl + 'guardarTemp', { medico: this.usuario, paciente: pacienteId, datos: this.jsonData }).subscribe(function (data) {
            if (data.ok == true) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire('Guardado', 'El registro ha sido guardado correctamente', 'success');
            }
            else {
                sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire('Oops...', 'Algo salio mal', 'error');
            }
        }, function (err) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire('Oops...', 'Algo salio mal', 'error');
        });
    ...
    TempComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-temp',
            template: __webpack_require__(/*! ./temp.component.html */ "./src/app/components/temperatura/temp.component.html"),
            styles: [__webpack_require__(/*! ./temp.component.css */ "./src/app/components/temperatura/temp.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"],
            _services_websocket_service__WEBPACK_IMPORTED_MODULE_2__["WebsocketService"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"],
            src_app_services_validar_service__WEBPACK_IMPORTED_MODULE_6__["ValidarService"]])
    ], TempComponent);
...
var UsuariosComponent = /** @class */ (function () {
    function UsuariosComponent(http) {
        this.http = http;
        this.baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].baseUrl;
    }
...
/* harmony import */ var _components_inicio_inicio_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/inicio/inicio.component */ "./src/app/components/inicio/inicio.component.ts");
/* harmony import */ var _components_pacientes_pacientes_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/pacientes/pacientes.component */ "./src/app/components/pacientes/pacientes.component.ts");
/* harmony import */ var _components_grafica_grafica_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/grafica/grafica.component */ "./src/app/components/grafica/grafica.component.ts");
/* harmony import */ var _components_registros_registros_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/registros/registros.component */ "./src/app/components/registros/registros.component.ts");
/* harmony import */ var _components_temperatura_temp_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/temperatura/temp.component */ "./src/app/components/temperatura/temp.component.ts");
/* harmony import */ var _components_usuarios_usuarios_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/usuarios/usuarios.component */ "./src/app/components/usuarios/usuarios.component.ts");
/* harmony import */ var _components_otros_otros_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/otros/otros.component */ "./src/app/components/otros/otros.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: 'pacientes', component: _components_pacientes_pacientes_component__WEBPACK_IMPORTED_MODULE_3__["PacientesComponent"] },
    { path: 'ecg', component: _components_grafica_grafica_component__WEBPACK_IMPORTED_MODULE_4__["GraficaComponent"] },
    { path: 'registros', component: _components_registros_registros_component__WEBPACK_IMPORTED_MODULE_5__["RegistrosComponent"] },
    { path: 'temp', component: _components_temperatura_temp_component__WEBPACK_IMPORTED_MODULE_6__["TempComponent"] },
    { path: 'usuarios', component: _components_usuarios_usuarios_component__WEBPACK_IMPORTED_MODULE_7__["UsuariosComponent"] },
    { path: 'otros', component: _components_otros_otros_component__WEBPACK_IMPORTED_MODULE_8__["OtrosComponent"] }
];
...
/* harmony import */ var _components_pacientes_pacientes_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/pacientes/pacientes.component */ "./src/app/components/pacientes/pacientes.component.ts");
/* harmony import */ var _components_grafica_grafica_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/grafica/grafica.component */ "./src/app/components/grafica/grafica.component.ts");
/* harmony import */ var _components_registros_registros_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/registros/registros.component */ "./src/app/components/registros/registros.component.ts");
/* harmony import */ var _components_temperatura_temp_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/temperatura/temp.component */ "./src/app/components/temperatura/temp.component.ts");
...
/* harmony import */ var _Consulta_ecgs_ecgs_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../Consulta/ecgs/ecgs.component */ "./src/app/Consulta/ecgs/ecgs.component.ts");
/* harmony import */ var _Consulta_bpms_bpms_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../Consulta/bpms/bpms.component */ "./src/app/Consulta/bpms/bpms.component.ts");
/* harmony import */ var _Consulta_temperatura_temperatura_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../Consulta/temperatura/temperatura.component */ "./src/app/Consulta/temperatura/temperatura.component.ts");
/* harmony import */ var _components_usuarios_usuarios_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../components/usuarios/usuarios.component */ "./src/app/components/usuarios/usuarios.component.ts");
/* harmony import */ var _components_otros_otros_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../components/otros/otros.component */ "./src/app/components/otros/otros.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    HomeModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                ...
                _components_pacientes_pacientes_component__WEBPACK_IMPORTED_MODULE_4__["PacientesComponent"],
                _components_grafica_grafica_component__WEBPACK_IMPORTED_MODULE_5__["GraficaComponent"],
                _components_registros_registros_component__WEBPACK_IMPORTED_MODULE_6__["RegistrosComponent"],
                _components_temperatura_temp_component__WEBPACK_IMPORTED_MODULE_7__["TempComponent"],
                _Consulta_ecgs_ecgs_component__WEBPACK_IMPORTED_MODULE_10__["EcgsComponent"],
                _Consulta_bpms_bpms_component__WEBPACK_IMPORTED_MODULE_11__["BpmsComponent"],
                _Consulta_temperatura_temperatura_component__WEBPACK_IMPORTED_MODULE_12__["TemperaturaComponent"],
                _components_otros_otros_component__WEBPACK_IMPORTED_MODULE_14__["OtrosComponent"],
                _components_usuarios_usuarios_component__WEBPACK_IMPORTED_MODULE_13__["UsuariosComponent"]
            ],
            imports: [
